...
<body>
    ...
    <!-- content -->
    <section id="academics" class="mata-kuliah">
        <div class="container-fluid">
            <div class="row set-row-academic">

                <div class="col-12 col-md-6">
                    <img src="c:\Users\rayka\OneDrive\Desktop\academics.jpg" width="" height="" alt="">
            ...
            <div class="container text-center">
                <div class="row justify-content-start">
                    <div class="row-cols-1 bg-primary">
                        PENGENALAN PEMROGRAMAN
                    </div>
                    <div class="row-cols-1 bg-primary-subtle">
                        ALGORITMA PEMROGRAMAN
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="row-cols-1 bg-secondary">
                        STRUKTUR DATA
                    </div>
                    <div class="row-cols-1 bg-secondary-subtle">
                        JARINGAN KOMPUTER
                    </div>
                </div>
                <div class="row justify-content-end">
                    <div class="row-cols-1 bg-success">
                        SISTEM OPERASI
                    </div>
                    <div class="row-cols-1 bg-success-subtle">
                        PEMODELAN IMPLEMENTASI BASIS DATA
                    </div>
                </div>
                <div class="row justify-content-around">
                    <div class="row-cols-1 bg-danger">
                        PEMROGRAMAN PERANGKAT KERAS
                    </div>
                    <div class="row-cols-1 bg-danger-subtle">
                        PEMROGRAMAN BERORIENTASI OBJEK
                    </div>
                </div>
                <div class="row justify-content-between">
                    <div class="row-cols-1 bg-warning">
                        PEMROGRAMAN WEB
                    </div>
                    <div class="row-cols-1 bg-warning-subtle">
                        BASIS DATA LANJUT
                    </div>
                </div>
                <div class="row justify-content-evenly">
                    ...
                    <div class="row-cols-1 bg-info-subtle">
                        JARINGAN ENTERPRISE
                    </div>
                </div>
            </div>
    ...
    <!-- Sosial media -->
    <footer>
        <section id="sosmed" class="container-fluid sosmed pb-5 pt-5">
            <div class="row">
                <div class="col-12">
