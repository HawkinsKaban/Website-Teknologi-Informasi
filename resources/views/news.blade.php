                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        ...
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="{{ asset('assets/images/news/ProximitiDay3.jpg ') }}"
                                    alt="" class="img-fluid"></a>
                            <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span>
                                <span>Jul 5th '22</span></div>
                            <h2><a href="single-post.html">Kegiatan Proximiti Day 3</a></h2>
                            <p class="mb-4 d-block">Lorem ipsum dolor sit, amet consectetur adipisicing elit...</p>

                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('assets/images/news/person-1.png') }}" alt=""
                                        class="img-fluid"></div>
                                <div class="name">
                                    <h3 class="m-0 p-0">Ray Hawkins Kaban</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('assets/images/news/FutsalEverest.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Sport</span> <span
                                            class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2><a href="single-post.html">Pertandingan Futsal Everest 2023</a></h2>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('assets/images/news/kantin-gku.webp') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Food</span> <span
                                            class="mx-1">&bullet;</span> <span>Jul 17th '22</span></div>
                                    <h2><a href="single-post.html">Destinasi Makanan Enak Di GKU</a></h2>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('assets/images/news/MarketDay.jpg ') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Business</span> <span
                                            class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2><a href="single-post.html">Kemeriahan Acara Market Day 2023</a></h2>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('assets/images/news/LaboratoriumTelkom.jpg ') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Tech</span> <span
                                            class="mx-1">&bullet;</span> <span>Mar 1st '22</span></div>
                                    <h2><a href="single-post.html">Labolatorium Telkom yang Sangat Nyaman</a></h2>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img
                                            src="{{ asset('assets/images/news/KunjuganTrans.jpg ') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Travel</span> <span
                                            class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2><a href="single-post.html">Kunjugan Mahasiswa Teknologi Infromasi ke TransTV</a></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-lg-flex post-entry-2">
                            <a href="single-post.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                                <img src="{{ asset('assets/images/news/ProximitiDay3.jpg ') }}" alt="" class="img-fluid">
                            </a>
                            <div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="post-entry-1 border-bottom">
                                    <a href="single-post.html"><img src="{{ asset('assets/images/news/ProximitiDay3.jpg ') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Culture</span> <span
                                            class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
