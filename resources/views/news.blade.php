                        ...
                        <div class="carousel slide" id="featuredPostsCarousel" data-bs-ride="carousel" >
                            <div class="carousel-inner" >
                                <div class="carousel-item active">
                                    <a href="single-post.html" class="d-block img-bg align-items-end" style="background-image: url('/assets/images/news/megabit.jpg');">
                                ...
                                <div class="carousel-item">
                                    <a href="single-post.html" class="d-block img-bg align-items-end" style="background-image: url('/assets/images/news/Penjahiman2.jpg');">
                                        <div class="img-bg-inner" style="color: white;">
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        ...
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="{{ asset('assets/images/news/ProximitiDay3.jpg ') }}" alt="" class="img-fluid"></a>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{ asset('assets/images/news/FutsalEverest.jpg') }}" alt="" class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Sport</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2><a href="single-post.html">Pertandingan Futasal Everest 2023</a></h2>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{ asset('assets/images/news/KunjuganTrans.jpg ') }}" alt="" class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Travel</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2><a href="single-post.html">Kunjugan Mahasiswa Teknologi Infromasi ke Trans TV</a></h2>
                                </div>
                            </div>
